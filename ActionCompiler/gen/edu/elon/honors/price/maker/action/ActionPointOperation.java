...
public class ActionPointOperation extends Action {					// ActionFragmentWriter.writeHeader()
	...
	public class WithVectorData extends ActionFragment {			// ActionFragmentWriter.writeHeader()
		...
		public Vector readVector(GameState gameState) {				// ActionFragmentWriter.writeElement()
		...
		public int readMagnitude(GameState gameState) {				// ActionFragmentWriter.writeElement()
