...
public class ActionTriggerActorAction extends ActionInstance {		// ActionFragmentWriter.writeHeader()
	public static final String NAME = "Trigger Actor Action";		// ActionWriter.writeHeader()
	public static final int ID = 18;								// ActionWriter.writeHeader()
