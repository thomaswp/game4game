...
public class ActionSetVelocity extends ScriptableInstance {			// ActionFragmentWriter.writeHeader()
	public static final String NAME = "Set Velocity";				// ScriptableWriter.writeHeader()
	public static final int ID = 10;								// ScriptableWriter.writeHeader()
	...
	public class SetActorData extends ScriptableFragment {			// ActionFragmentWriter.writeHeader()
	...
	public class SetObjectData extends ScriptableFragment {			// ActionFragmentWriter.writeHeader()
	...
	public Vector readDirectionVector(GameState gameState) throws ParameterException {// ActionFragmentWriter.writeElement()
	...
	public int readDirectionMagnitude(GameState gameState) throws ParameterException {// ActionFragmentWriter.writeElement()
