			...
			if (mRenderables != null) {
				...
				final float timeDeltaSeconds = 
					...
					for (int x = 0; x < mRenderables.length; x++) {
						...
						object.rotation = (object.rotation + 100 * timeDeltaSeconds) % 360;
						object.zoom += 1 * (object.rotation > 180 ? -1 : 1) * timeDeltaSeconds;
						object.ox = object.width / 2;
						object.oy = object.height / 2;
