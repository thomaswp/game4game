...
public class ActionFactory {										// ActionFactoryWriter.writeHeader()
	...
	public static void loadInterpreters() {							// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterSetSwitch");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterSetVariable");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterCreateActor");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterDebugBox");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterMoveActor");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterTriggerActorBehavior");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterIf");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterCreateObject");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterMoveObject");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterSetVelocity");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterDebugMessage");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterPointOperation");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterChangeGravity");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterUIInterpreter");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterDestroyObject");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterDrawToScreen");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
			Class.forName("edu.elon.honors.price.maker.action.InterpreterLoop");// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
	}																// ActionFactoryWriter.writeHeader()
}																	// ActionFactoryWriter.writeHeader()
