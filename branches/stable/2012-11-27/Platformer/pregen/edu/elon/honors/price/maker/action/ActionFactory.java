...
public class ActionFactory {										// ActionFactoryWriter.writeHeader()
	...
	public static java.util.LinkedList<Class<?>> getInterpreters() {// ActionFactoryWriter.writeHeader()
		...
		try {														// ActionFactoryWriter.writeHeader()
			classes.add(Class.forName("edu.elon.honors.price.maker.action.InterpreterUIInterpreter"));// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
		try {														// ActionFactoryWriter.writeHeader()
		...
		try {														// ActionFactoryWriter.writeHeader()
			classes.add(Class.forName("edu.elon.honors.price.maker.action.InterpreterTestInterpreter"));// ActionFactoryWriter.writeHeader()
		} catch (Exception e) { }									// ActionFactoryWriter.writeHeader()
