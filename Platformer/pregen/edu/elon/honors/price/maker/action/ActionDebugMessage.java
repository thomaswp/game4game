...
public class ActionDebugMessage extends ScriptableInstance {		// ActionFragmentWriter.writeHeader()
	public static final String NAME = "Debug Message";				// ScriptableWriter.writeHeader()
	public static final int ID = 11;								// ScriptableWriter.writeHeader()
