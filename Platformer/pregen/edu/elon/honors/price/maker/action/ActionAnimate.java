...
public class ActionAnimate extends ActionInstance {					// ActionFragmentWriter.writeHeader()
	public static final String NAME = "Animate";					// ActionWriter.writeHeader()
	public static final int ID = 19;								// ActionWriter.writeHeader()
	public static final String CATEGORY = "Animate";				// ActionWriter.writeHeader()
																	// ActionWriter.writeHeader()
	...
	public class AnimateActorData extends ActionFragment {			// ActionFragmentWriter.writeHeader()
	...
	public class AnimateObjectData extends ActionFragment {			// ActionFragmentWriter.writeHeader()
	...
	public class WithBounceData extends ActionFragment {			// ActionFragmentWriter.writeHeader()
